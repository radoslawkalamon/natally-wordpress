...
add_action('wp_enqueue_scripts', function () {
  ...
  wp_register_style('google-fonts', 'https://fonts.googleapis.com/css2?family=PT+Serif:wght@400;700&family=Source+Sans+Pro:wght@700&display=swap', array(), '2.4', 'all');
